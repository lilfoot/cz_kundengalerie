...
{if ($oKundengaleriePlugin->oPluginEinstellungAssoc_arr.kundengalerie_gekauft eq 'y' && bGekauft) || ($oKundengaleriePlugin->oPluginEinstellungAssoc_arr.kundengalerie_gekauft eq 'n')}
