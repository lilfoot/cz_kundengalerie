<?php
    ...
    class cz_kundengalerie 
    {
        ...
        public function zeigeBilder($bAktiv=false,$kArtikel=0,$nSeite=1)
        {
        	...
        	$cSql = "SELECT xplugin_cz_kundengalerie_bilder.*,xplugin_cz_kundengalerie_kuponcounter.nKuponAnzahl FROM xplugin_cz_kundengalerie_bilder
        				LEFT JOIN xplugin_cz_kundengalerie_kuponcounter ON xplugin_cz_kundengalerie_kuponcounter.kKunde=xplugin_cz_kundengalerie_bilder.kKunde 
        				WHERE
        					bAktiv=";
        	$cSql .= ($bAktiv)?"'y' ":"'n' ";
			if ($kArtikel>0)
